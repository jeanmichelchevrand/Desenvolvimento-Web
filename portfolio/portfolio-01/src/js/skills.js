...
const btnAvancar = document.getElementById("btt-avancar");
const btnVoltar = document.getElementById("btt-voltar");

// Seleciona as listas de habilidades
const lista1 = document.querySelector(".skills-1");
const lista2 = document.querySelector(".skills-2");
