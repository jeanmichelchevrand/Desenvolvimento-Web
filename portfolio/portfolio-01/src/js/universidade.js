...
const btnAvancar = document.getElementById("btt-avancar-univer");
const btnVoltar = document.getElementById("btt-voltar-univer");

// Seleciona as listas de habilidades
const lista1 = document.querySelector(".univer-1");
const lista2 = document.querySelector(".univer-2");
